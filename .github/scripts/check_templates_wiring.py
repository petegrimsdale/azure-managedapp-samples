...
mainTemplatePath = Path(
    os.environ.get("MAIN_TEMPLATE_PATH", "pg-templates/managed-storage/main.json")
)
uiTemplatePath = Path(
    os.environ.get("UI_TEMPLATE_PATH", "pg-templates/managed-storage/createUiDefinition.json")
)
